        ...
        <div className={style.container}>
                  ...
                  <ul className={style.categorySublist}>
                    {categories[gender].list.map(category => (
                      <li key={category.slug}>
                        <NavLink to={`/catalog/${gender}/${category.slug}`} className={style.link}>{category.title}</NavLink>
                      </li>
                    ))}
                  </ul>
                </li>
          ...
          <div className={style.development}>
            <ul className={style.developmentList}>
              <li>
                Designer: <a href="#" className={style.link}>Anastasia Ilina</a>
              </li>
              <li>
                Developer: <a href="#" className={style.link}>Gerasimovich Sergey</a>
              </li>
            </ul>
          </div>
        </div>
